...
export default {
  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      const userCall = await axios.get(`${process.env.VUE_APP_ADMIN_URL_PATH_ADMIN}/users/${params.id}`);
    ...
    const submit = async () => {
      await axios.put(`${process.env.VUE_APP_ADMIN_URL_PATH_ADMIN}/users/${params.id}`, {
